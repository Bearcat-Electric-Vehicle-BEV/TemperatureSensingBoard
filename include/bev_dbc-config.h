...
/* #define BEV_DBC_USE_BITS_SIGNAL */
...
/* #define BEV_DBC_USE_DIAG_MONITORS */


/* ------------------------------------------------------------------------- *
  When monitor using is enabled (BEV_DBC_USE_DIAG_MONITORS) and define below
